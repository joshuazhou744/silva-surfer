...
VALORANT_TITLE_URL = os.getenv("VALORANT_TITLE_URL", "https://media.valorant-api.com/playertitles")
VALORANT_AGENT_URL = os.getenv("VALORANT_AGENT_URL", "https://media.valorant-api.com/agents")
VALORANT_MAP_URL = os.getenv("VALORANT_MAP_URL", "https://media.valorant-api.com/maps")
